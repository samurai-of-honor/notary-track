...
(function (TheDatepicker) {
  ...
  const Datepicker = (function () {
    ...
    Datepicker.prototype.createDeselectElement_ = function () {
      ...
      const title = this.options.translator.translateTitle(TheDatepicker.TitleName.Deselect);
      if (title !== '') {
...
(function (TheDatepicker) {
  ...
  const Options = (function () {
    ...
    Options.prototype.setMinDate = function (date) {
      const normalizedDate = TheDatepicker.Helper_.normalizeDate_('Min date', date, true, this);
    ...
    Options.prototype.setMaxDate = function (date) {
      const normalizedDate = TheDatepicker.Helper_.normalizeDate_('Max date', date, true, this);
...
(function (TheDatepicker) {
  ...
  const ViewModel_ = (function () {
    ...
    ViewModel_.prototype.createDay_ = function (date) {
      ...
      const currentMonth = this.getCurrentMonth_();
      const day = new TheDatepicker.Day(date, (date) => _this.createDay_(date), (date) => _this.dateConverter_.formatDate_(_this.options_.getInputFormat(), date));
